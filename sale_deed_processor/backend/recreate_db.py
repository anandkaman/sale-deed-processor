...
def main():
    ...
    try:
        ...
        logger.info("- Property Details: Removed total_land_area, address")
        logger.info("- Property Details: Added schedule_b_area (Float)")
        logger.info("- Property Details: Added schedule_c_property_name (String)")
        logger.info("- Property Details: Added schedule_c_property_address (String)")
        logger.info("- Property Details: Added schedule_c_property_area (Float)")
        logger.info("- Property Details: Added paid_in_cash_mode (String)")
